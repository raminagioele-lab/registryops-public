...
### 4.2 Schema Versions
- `schema_event.json` and `schema_state.json` are the current canonical public schema artifacts.
- Backward-incompatible schema changes require an explicit future versioning decision and a new schema line.
- Older published schema lines, once introduced, MUST remain publicly accessible for historical verification.
...
Target path:
- `public/governance/publication_governance.md`
