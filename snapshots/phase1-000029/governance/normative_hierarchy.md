...
The phase 1.1 observable-fingerprint extension follows the same hierarchy and
does not create a separate normative line.
...
- `registry/spec/` and `registry/taxonomy/` express the executable public rule,
  including the phase 1.1 observable-fingerprint extension.
